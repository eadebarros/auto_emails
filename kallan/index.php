...
$produto = explode('<h1 class="name fn" itemprop="name">',$pagina);
$produto = explode('</h1>',$produto[1]);

$depor = explode('<span id="lblPreco" class="regular">de',$pagina);
$depor = explode('</span>',$depor[1]);
$depor = array_filter($depor);

if(!empty($depor[0]) || $depor[0] = "") {
    $preco = explode('<span id="lblPrecoPor" class="price sale" itemprop="price">por <strong>',$pagina);
