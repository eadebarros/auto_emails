...
//die($pagina);
$produto = explode('<h1 class="name" itemprop="name">',$pagina);
$produto = explode('</h1>',$produto[1]);

$img = explode('<img id="ProdutoImagemAux" name="ProdutoImagemAux" itemprop="image" src="',$pagina);
$img = explode('"',$img[1]);

#Preço do produto cheio
$preco = explode('<span id="lblPrecoPor" class="price sale" itemprop="price"><strong>',$pagina);
$preco = explode('</strong>',$preco[1]);

#quantidade de parcelas
$QtdParcelas = explode('<span id="lblParcelamento" class="parcel"><span id="lblParcelamento1"><strong>',$pagina);
$QtdParcelas = explode('</strong> <i>de</i></span>', $QtdParcelas[1]);

#valor das parcelas
$ValorParcelas = explode('<span id="lblParcelamento2"> <strong>',$pagina);
$ValorParcelas = explode('</strong> <b>sem juros</b></span>', $ValorParcelas[1]);

#Eliminando valores vazios, 0 ou falsos do array
$QtdParcelas = array_filter($QtdParcelas);

$parcelado = '<div style="width: 100%; overflow: hidden; font-family: Verdana, sans-serif; font-weight: bold;font-size: 12px; color: #ed4978; text-align: center; padding-bottom: 2px;">
        em '.$QtdParcelas[0].'<span style="color:#ed4978"> de </span> '.$ValorParcelas[0].'
      </div>';
$semparcela = '<div style="width: 100%; overflow: hidden; font-family: Verdana, sans-serif; font-weight: bold;font-size: 12px; color: #ed4978; text-align: center; padding-bottom: 2px;">
        &nbsp;
      </div>';
...
<span style="display: inline-block; width: 190px; vertical-align: middle;" class="product" id="ipad">
      ...
      . $div = (!empty($QtdParcelas) ? $parcelado : $semparcela). 
      ...
      <center>
         <div style="max-width:600px;overflow:hidden;background-color:#FFFFFF;">
            <table style="max-width:600px;" align="center" border="0" bgcolor="#000000" cellpadding="0" cellspacing="0" width="auto">
               <tbody>
                  <tr>
                     <td align="right" bgcolor="#FFFFFF" style="padding-left:10px;padding-right:10px;border-right:1px solid #666666;padding-top:5px;padding-bottom:5px;" target="_blank"><a href="http://www.belacenter.com.br/corpo-banho-23.aspx/u'.$utms.'" style="text-decoration: none;font-family:Arial, Helvetica, sans-serif;font-size:10px;color:#000000;">CORPOE E BANHO</a></td>
                     <td bgcolor="#FFFFFF" style="padding-left:10px;padding-right:10px;padding-top:5px;border-right:1px solid #666666;padding-bottom:5px;" target="_blank"><a href="http://www.belacenter.com.br/cuidados-com-a-pele-19.aspx/u'.$utms.'" style="text-decoration: none;font-family:Arial, Helvetica, sans-serif;font-size:10px;color:#000000;">PARA A PELE</a></td>
                     <td bgcolor="#FFFFFF" style="padding-left:10px;padding-right:10px;padding-top:5px;border-right:1px solid #666666;padding-bottom:5px;" target="_blank"><a href="http://www.belacenter.com.br/maquiagem-11.aspx/u'.$utms.'" style="text-decoration: none;font-family:Arial, Helvetica, sans-serif;font-size:10px;color:#000000;">MAQUIAGEM</a></td>
                     <td bgcolor="#FFFFFF" style="padding-left:10px;padding-right:10px;padding-top:5px;border-right:1px solid #666666;padding-bottom:5px;" target="_blank"><a href="http://www.belacenter.com.br/cabelos-1.aspx/c'.$utms.'" style="text-decoration: none;font-family:Arial, Helvetica, sans-serif;font-size:10px;color:#000000;">CABELOS</a></td>
                     <td bgcolor="#FFFFFF" style="padding-left:10px;padding-right:10px;padding-top:5px;padding-bottom:5px;" target="_blank"><a href="http://www.belacenter.com.br/presentes-48.aspx/u'.$utms.'" style="text-decoration: none;font-family:Arial, Helvetica, sans-serif;font-size:12px;color:#b62826;"><strong>PRESENTES</strong></a></td>
                  </tr>
               </tbody>
            </table>
         </div>
